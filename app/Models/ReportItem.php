...
class ReportItem extends Model
{
	...
	protected $casts = [
		...
		'da' => 'integer',
		'authority_final' => 'integer',
		'authority_source' => 'string',
		'traffic_estimated' => 'integer',
	];
	...
	// ✅ ETV = valeur € estimée / mois (déjà une valeur)
	public function estimatedSeoValueEur(): ?float
	{
		if ($this->traffic_etv === null) return null;
		return round((float) $this->traffic_etv, 2);
	}

	// ✅ estimation visites/mois à partir de l’ETV et du CPC moyen
	public function estimatedSeoVisitsMonthly(): ?int
	{
		if ($this->traffic_etv === null) return null;
		...
		return (int) round(((float) $this->traffic_etv) / $cpc);
	}
